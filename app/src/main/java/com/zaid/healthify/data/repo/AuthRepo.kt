...
import com.zaid.healthify.data.models.local.User
import com.zaid.healthify.data.models.mapper.UserMapper
...
import com.zaid.healthify.util.USER_DOES_NOT_EXIST
import com.zaid.healthify.util.getSleepQuantity
import com.zaid.healthify.util.getWaterQuantity
