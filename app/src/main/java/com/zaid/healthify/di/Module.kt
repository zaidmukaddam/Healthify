...
import com.zaid.healthify.data.local.room.HealthifyDB
...
import com.zaid.healthify.data.models.mapper.WaterMapper
...
object Module {
    ...
    @Provides
    fun providesLeaderBoardMapper(): LeaderBoardItemMapper =
