...
***You can Install and test latest Healthify appz from below 👇***

[![Healthify](https://img.shields.io/badge/Healthify✅-APK-red.svg?style=for-the-badge&logo=android)](https://github.com/zaidmukaddam/Healthify/releases/tag/v1.0.0)
...
**Healthify** uses Auth0 for authentication. It supports email-based authentication as well as Google authentication.

**Healthify** also has a smooth user onboarding process.
...
# Package Structure
    ...
    com.zaid.healthify    # Root Package
    .
